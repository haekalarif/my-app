...
import { DetailsList, DetailsListLayoutMode, Selection, SelectionMode, IColumn, IDetailsListCheckboxProps, IDetailsRowProps } from '@fluentui/react/lib/DetailsList';
...
export class DetailListAdvance extends React.Component<{}, IDetailsListDocumentsExampleState> {
                ...
                {isModalSelection ? (
                    <MarqueeSelection selection={this._selection}>
                        <DetailsList
                            ...
                            // onRenderCheckbox={(props, defaulRender) => {
                            //     console.log(props);
                            //     console.log(defaulRender);
                            //     return <></>
                            // }}
                            onRenderCheckbox={(props: IDetailsListCheckboxProps, defaultRender?: (p?: IDetailsListCheckboxProps) => JSX.Element) => {
                                // Custom behavior or styling logic can be added here
                                // console.log(props);
                                if (defaultRender) {
                                    return (
                                        <div style={{ backgroundColor: 'lightyellow', padding: '2px', borderRadius: '4px' }}>
                                            {defaultRender(props)}
                                            {/* {console.log(defaultRender(props))} */}
                                        </div>
                                    );
                                }
                                return null; // If no defaultRender is provided, return null or your fallback UI
                            }}
                            onRenderRow={(props?: IDetailsRowProps, defaultRender?: (props?: IDetailsRowProps) => JSX.Element) => {
                                console.log(props);
                                // console.log(defaultRender(props).props);
